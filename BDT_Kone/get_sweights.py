...
if __name__ == '__main__':
    ...
    parser.add_argument("-d", "--directory" , default="BDT_Kone/weights/" , action='store',
...
# I WRITE
# python BDT_Kone/get_sweights.py "/eos/lhcb/user/p/pvidrier/roots/data_Kone_with_cuts.root" "BDT_Kone/params.yaml" "BDT_Kone/weights/weights.root" -m "/eos/lhcb/user/p/pvidrier/roots/mc_Kone_with_cuts_Bu_JpsiConstr.root"
