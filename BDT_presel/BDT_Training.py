...
def BDT_Training(mcfile,mctree,cutsmc,datafile,datatree,cutsdata,variables,name):
    ...
    xgb_classifier.save_model("BDT_presel/data/%s.json" % name)
    ...
    plt.ylabel(None)
    plt.grid(False)
    plt.savefig("BDT_presel/plots/BDT/Feature_Importance.png", dpi=300)
    plt.close()
    ...
    plt.savefig("BDT_presel/plots/BDT/Predictions.png")
    plt.close()
    ...
    plt.savefig("BDT_presel/plots/BDT/ROC.png")
    plt.close()
    ...
    plt.title("ROC")
    plt.legend(loc="lower right")
    plt.savefig("BDT_presel/plots/BDT/ROC_corner.png")
    plt.close()
    ...
    plt.title("ROC")
    plt.legend(loc="lower right")
    plt.savefig("BDT_presel/plots/BDT/ROC_error.png")
    plt.close()
    ...
    plt.savefig("BDT_presel/plots/BDT/FoM.png")
    plt.close()
    ...
    with open('BDT_presel/data/%s_Best_cut.txt' % name, 'w') as f:
            f.write(str(bestcut))
    f.close
    ...
    plt.title("FoM")
    plt.legend(loc="lower center")
    plt.savefig("BDT_presel/plots/BDT/FoM_peak.png")
    plt.close()
...
variables="BDT_presel/data/variableselection.yaml"
name="BDT"
