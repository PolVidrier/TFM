...
with open("private/BDT_B2JpsiKRD/variableselection.yaml","r") as file:
...
for var in dictionary:
    ...
    plt.legend(["MC","data"])
    plt.savefig("private/BDT_B2JpsiKRD/plots/Usedvariables/{}.png".format(var))
    plt.close()
...
plt.ylabel(False)
plt.grid(False)
plt.savefig("private/BDT_B2JpsiKRD/plots/featureimportance.png")
plt.close()
...
plt.savefig("private/BDT_B2JpsiKRD/plots/predictions.png")
plt.close()
...
plt.savefig("private/BDT_B2JpsiKRD/plots/ROC.png")
plt.close()
...
plt.savefig("private/BDT_B2JpsiKRD/plots/FoM.png")
plt.close()

# PREDICTION OF THE MASS
print("Prediction of the mass")
# Data without the window cut
fulldatapd=data.arrays(features,"Jpsi_M>20",library="pd")
...
plt.savefig("private/BDT_B2JpsiKRD/plots/Jpsi_M.png")
plt.close()