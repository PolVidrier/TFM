...
mcpd=mc.arrays(featuresmc,"(Bu_BKGCAT==0) & (L1_HASBREM==False) & (L2_HASBREM==False)",library="pd")
datapd=data.arrays(features,"(Jpsi_M > 3200) & (ep_HASBREM==False) & (ep_HASBREM==False)",library="pd")
...
plt.ylabel(None)
plt.grid(False)
plt.savefig("BDT_B2JpsiKRD/plots/0BREM/featureimportance.png", dpi=300)
plt.close()
...
plt.savefig("BDT_B2JpsiKRD/plots/0BREM/predictions.png")
plt.close()
...
plt.savefig("BDT_B2JpsiKRD/plots/0BREM/ROC.png")
plt.close()
...
plt.savefig("BDT_B2JpsiKRD/plots/0BREM/FoM.png")
plt.close()

# PREDICTION OF THE JPSI MASS
print("Prediction of the Jpsi mass")
# Data without the window cut
fulldatapd=data.arrays(features,"(Jpsi_M>100) & (ep_HASBREM==False) & (ep_HASBREM==False)",library="pd")
...
plt.savefig("BDT_B2JpsiKRD/plots/0BREM/Jpsi_M.png")
plt.close()

with open('BDT_B2JpsiKRD/data_Jpsi_M_0BREM.txt', 'w') as f:
...
plt.xlabel("Jpsi_M")
plt.legend(loc="upper left")
plt.savefig("BDT_B2JpsiKRD/plots/0BREM/Jpsi_M_mc_comparison.png")
plt.close()
...
plt.xlabel("Bu_M")
plt.legend(loc="upper left")
plt.savefig("BDT_B2JpsiKRD/plots/0BREM/Bu_M.png")
plt.close()