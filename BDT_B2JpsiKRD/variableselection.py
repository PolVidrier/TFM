...
for var in feature_list:
    for varmc in feature_listmc: 
        if var==varmc:
            if var in ["Bu_MAX_PT","Jpsi_BPVIPCHI2","Jpsi_BPVIP","Bu_BPVIPCHI2","Bu_BPVIP","Bu_MAXDOCA","Bu_MIN_PT","Bu_MIN_P","Bu_ETA","Jpsi_ETA","Bu_M","Bu_PT","Jpsi_PT","Jpsi_M","Bu_MIN_PT","Bu_SUM_PT","Jpsi_PZ"]:
