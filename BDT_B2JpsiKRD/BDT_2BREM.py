...
mcpd=mc.arrays(featuresmc,"(Bu_BKGCAT==0) & (L1_HASBREM==True) & (L2_HASBREM==True)",library="pd")
datapd=data.arrays(features,"(Jpsi_M > 3200) & (ep_HASBREM==True) & (ep_HASBREM==True)",library="pd")
...
plt.ylabel(None)
plt.grid(False)
plt.savefig("BDT_B2JpsiKRD/plots/2BREM/featureimportance.png", dpi=300)
plt.close()
...
plt.savefig("BDT_B2JpsiKRD/plots/2BREM/predictions.png")
plt.close()
...
plt.savefig("BDT_B2JpsiKRD/plots/2BREM/ROC.png")
plt.close()
...
plt.savefig("BDT_B2JpsiKRD/plots/2BREM/FoM.png")
plt.close()

# PREDICTION OF THE JPSI MASS
print("Prediction of the Jpsi mass")
# Data without the window cut
fulldatapd=data.arrays(features,"(Jpsi_M>100) & (ep_HASBREM==True) & (ep_HASBREM==True)",library="pd")
...
plt.savefig("BDT_B2JpsiKRD/plots/2BREM/Jpsi_M.png")
plt.close()

with open('BDT_B2JpsiKRD/data_Jpsi_M_2BREM.txt', 'w') as f:
...
plt.xlabel("Jpsi_M")
plt.legend(loc="upper left")
plt.savefig("BDT_B2JpsiKRD/plots/2BREM/Jpsi_M_mc_comparison.png")
plt.close()
...
plt.xlabel("Bu_M")
plt.legend(loc="upper left")
plt.savefig("BDT_B2JpsiKRD/plots/2BREM/Bu_M.png")
plt.close()