# SAME AS SIMPLEFIT BUT WITH A RooCrystalBall AS BACKGROUND
...
def ballFit(tree, cuts, mean_val, xmin = 4000, xmax = 7000):
    """
    ...
    massFrame.Draw()
    #Save the result
    can.SaveAs("/afs/cern.ch/work/p/pvidrier/private/GITHUB/FITTING/myFIT.png")
    #####################
...
if __name__=="__main__":
    ...
    # fit it
    ballFit(tree, args.cuts, args.mean,args.xmin, args.xmax)
