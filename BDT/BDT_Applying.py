...
cutsplus="(Jpsi_M>100) & (acos((ep_ENERGY*em_ENERGY-ep_PX*em_PX-ep_PY*em_PY-ep_PZ*em_PZ)/(ep_P*em_P))>0.0005) & ((Hlt1_Hlt1DisplacedDielectronDecision==1) | (Hlt1_Hlt1DisplacedLeptonsDecision==1) | (Hlt1_Hlt1LowMassNoipDielectronDecision==1) | (Hlt1_Hlt1SingleHighEtDecision==1) | (Hlt1_Hlt1SingleHighPtElectronDecision==1) | (Hlt1_Hlt1TrackElectronMVADecision==1))"
...
tree="DecayTree"
cuts="Bu_BKGCAT==0" 
cutsplus="(Bu_BKGCAT==0) & (acos((ep_ENERGY*em_ENERGY-ep_PX*em_PX-ep_PY*em_PY-ep_PZ*em_PZ)/(ep_P*em_P))>0.0005)" 
name="mc"
