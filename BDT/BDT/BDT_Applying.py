...
tree="DecayTree"
cuts="Bu_BKGCAT==0" 
cutsplus="(Bu_BKGCAT==0) & (acos((ep_PX*em_PX+ep_PY*em_PY+ep_PZ*em_PZ)/(ep_P*em_P))>0.0005) & (acos((ep_PX*Kp_PX+ep_PY*Kp_PY+ep_PZ*Kp_PZ)/(ep_P*Kp_P))>0.0005) & (acos((Kp_PX*em_PX+Kp_PY*em_PY+Kp_PZ*em_PZ)/(Kp_P*em_P))>0.0005) & (ep_PT>500) & (em_PT>500)"
name="mc"
...
file="/afs/cern.ch/work/p/pvidrier/private/roots/data/Jpsi2ee_MagAll.root"
tree="tuple_B2JpsiKRD/DecayTree;1"
cutsplus="(Jpsi_M>3200) & (acos((ep_PX*em_PX+ep_PY*em_PY+ep_PZ*em_PZ)/(ep_P*em_P))>0.0005) & ((Hlt1_Hlt1DisplacedDielectronDecision==1) | (Hlt1_Hlt1DisplacedLeptonsDecision==1) | (Hlt1_Hlt1LowMassNoipDielectronDecision==1) | (Hlt1_Hlt1SingleHighEtDecision==1) | (Hlt1_Hlt1SingleHighPtElectronDecision==1) | (Hlt1_Hlt1TrackElectronMVADecision==1))"
cutsforROOT="Jpsi_M>100 && angle(em,ep)>0.0005 && (Hlt1_Hlt1DisplacedDielectronDecision || Hlt1_Hlt1DisplacedLeptonsDecision || Hlt1_Hlt1LowMassNoipDielectronDecision || Hlt1_Hlt1SingleHighEtDecision || Hlt1_Hlt1SingleHighPtElectronDecision || Hlt1_Hlt1TrackElectronMVADecision)"
name="data_bkg"  
...
bestcut="BDT/data/BDT_Best_cut.txt"
variables="BDT/data/variableselection.yaml"
file="/eos/lhcb/user/a/alopezhu/Jpsi2ee/data/Jpsi2ee_MagUp_presel_EMTFruns.root"
tree="DecayTree"
cutsplus="(Jpsi_M>100) & (acos((ep_PX*em_PX+ep_PY*em_PY+ep_PZ*em_PZ)/(ep_P*em_P))>0.0005) & ((Hlt1_Hlt1DisplacedDielectronDecision==1) | (Hlt1_Hlt1DisplacedLeptonsDecision==1) | (Hlt1_Hlt1LowMassNoipDielectronDecision==1) | (Hlt1_Hlt1SingleHighEtDecision==1) | (Hlt1_Hlt1SingleHighPtElectronDecision==1) | (Hlt1_Hlt1TrackElectronMVADecision==1))"
cutsforROOT="Jpsi_M>100 && angle(em,ep)>0.0005 && (Hlt1_Hlt1DisplacedDielectronDecision || Hlt1_Hlt1DisplacedLeptonsDecision || Hlt1_Hlt1LowMassNoipDielectronDecision || Hlt1_Hlt1SingleHighEtDecision || Hlt1_Hlt1SingleHighPtElectronDecision || Hlt1_Hlt1TrackElectronMVADecision)"
name="Jpsi2ee_MagUp_presel_EMTFruns"  
...
bestcut="BDT/data/BDT_Best_cut.txt"
variables="BDT/data/variableselection.yaml"
file="/eos/lhcb/user/a/alopezhu/Jpsi2ee/data/Jpsi2ee_MagDown_presel_EMTFruns.root"
tree="DecayTree"
cutsplus="(Jpsi_M>100) & (acos((ep_PX*em_PX+ep_PY*em_PY+ep_PZ*em_PZ)/(ep_P*em_P))>0.0005) & ((Hlt1_Hlt1DisplacedDielectronDecision==1) | (Hlt1_Hlt1DisplacedLeptonsDecision==1) | (Hlt1_Hlt1LowMassNoipDielectronDecision==1) | (Hlt1_Hlt1SingleHighEtDecision==1) | (Hlt1_Hlt1SingleHighPtElectronDecision==1) | (Hlt1_Hlt1TrackElectronMVADecision==1))"
cutsforROOT="Jpsi_M>100 && angle(em,ep)>0.0005 && (Hlt1_Hlt1DisplacedDielectronDecision || Hlt1_Hlt1DisplacedLeptonsDecision || Hlt1_Hlt1LowMassNoipDielectronDecision || Hlt1_Hlt1SingleHighEtDecision || Hlt1_Hlt1SingleHighPtElectronDecision || Hlt1_Hlt1TrackElectronMVADecision)"
name="Jpsi2ee_MagDown_presel_EMTFruns"  
...
bestcut="BDT/data/BDT_Best_cut.txt"
variables="BDT/data/variableselection.yaml"
file="/eos/lhcb/user/a/alopezhu/EMTF/data/Jpsi2ee_v10Alig/B2JpsiKLFU_MagDown_presel.root"
tree="DecayTree"
cutsplus=""
#cutsplus="(Jpsi_M>100) & (acos((ep_PX*em_PX+ep_PY*em_PY+ep_PZ*em_PZ)/(ep_P*em_P))>0.0005) & ((Hlt1_Hlt1DisplacedDielectronDecision==1) | (Hlt1_Hlt1DisplacedLeptonsDecision==1) | (Hlt1_Hlt1LowMassNoipDielectronDecision==1) | (Hlt1_Hlt1SingleHighEtDecision==1) | (Hlt1_Hlt1SingleHighPtElectronDecision==1) | (Hlt1_Hlt1TrackElectronMVADecision==1))"
cutsforROOT="Jpsi_M>100 && angle(em,ep)>0.0005 && (Hlt1_Hlt1DisplacedDielectronDecision || Hlt1_Hlt1DisplacedLeptonsDecision || Hlt1_Hlt1LowMassNoipDielectronDecision || Hlt1_Hlt1SingleHighEtDecision || Hlt1_Hlt1SingleHighPtElectronDecision || Hlt1_Hlt1TrackElectronMVADecision)"
name="B2JpsiKLFU_MagDown_presel"  
...
bestcut="BDT/data/BDT_Best_cut.txt"
variables="BDT/data/variableselection.yaml"
file="/eos/lhcb/user/a/alopezhu/EMTF/data/Jpsi2ee_v10Alig/B2JpsiKLFU_MagUp_presel.root"
tree="DecayTree"
cutsplus=""
#cutsplus="(Jpsi_M>100) & (acos((ep_PX*em_PX+ep_PY*em_PY+ep_PZ*em_PZ)/(ep_P*em_P))>0.0005) & ((Hlt1_Hlt1DisplacedDielectronDecision==1) | (Hlt1_Hlt1DisplacedLeptonsDecision==1) | (Hlt1_Hlt1LowMassNoipDielectronDecision==1) | (Hlt1_Hlt1SingleHighEtDecision==1) | (Hlt1_Hlt1SingleHighPtElectronDecision==1) | (Hlt1_Hlt1TrackElectronMVADecision==1))"
cutsforROOT="Jpsi_M>100 && angle(em,ep)>0.0005 && (Hlt1_Hlt1DisplacedDielectronDecision || Hlt1_Hlt1DisplacedLeptonsDecision || Hlt1_Hlt1LowMassNoipDielectronDecision || Hlt1_Hlt1SingleHighEtDecision || Hlt1_Hlt1SingleHighPtElectronDecision || Hlt1_Hlt1TrackElectronMVADecision)"
name="B2JpsiKLFU_MagUp_presel"  
