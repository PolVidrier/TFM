...
if __name__ == '__main__':
    ...
    parser.add_argument("-d", "--directory" , default="BDT_Ktwo/weights/" , action='store',
...
# I WRITE
# python BDT_Ktwo/get_sweights.py "/eos/lhcb/user/p/pvidrier/roots/data_Ktwo_with_cuts.root" "BDT_Ktwo/params.yaml" "BDT_Ktwo/weights/weights.root" -m "/eos/lhcb/user/p/pvidrier/roots/mc_Ktwo_with_cuts_Bu_JpsiConstr.root"
