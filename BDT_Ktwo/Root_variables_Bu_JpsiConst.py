...
rfile = ROOT.TFile("/eos/lhcb/user/p/pvidrier/roots/mc_Ktwo_with_cuts.root")
...
array2root(new_data, "/eos/lhcb/user/p/pvidrier/roots/mc_Ktwo_with_cuts_Bu_JpsiConstr.root", "DecayTree",mode="RECREATE")
